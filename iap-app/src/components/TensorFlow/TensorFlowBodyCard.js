        ...
        <div className="bg-white rounded-lg p-4 m-4 shadow-lg cursor-pointer">
            ...
            <div style={{flex:"7"}}>
                ...
                <div style={{fontSize:"10px",fontWeight:"600", color:"#6b7280"}}>
                    It measures the details based on DORA recommended practise. 
                </div>
                <div>
                <a style={{color:"red"}} href="https://worker2.prince.prokarma.com/home" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="0">p-Score (prokarma.com)</a>
                </div>
            </div>
